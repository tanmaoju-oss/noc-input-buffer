...
module tb_mesh_injection_sweep_5x5_noxim_queue_knee #(
    ...
    task dump_output();
        $dumpfile("out.vcd");
        $dumpvars(0, tb_mesh_injection_sweep_5x5_noxim_queue_knee);//Modify use independent knee-rate queue-based sweep top, Michael Tan, 20260709
    endtask
