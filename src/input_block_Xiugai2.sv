...
/*
    output logic [VC_NUM-1:0] va_request_o [PORT_NUM-1:0],
    output port_t [VC_NUM-1:0] out_port_o [PORT_NUM-1:0],
    input logic [VC_SIZE-1:0] va_new_vc_i [PORT_NUM-1:0] [VC_NUM-1:0],
    input logic [VC_NUM-1:0] va_valid_i [PORT_NUM-1:0],

    output logic [VC_SIZE-1:0] sa_downstream_vc_o [PORT_NUM-1:0][VC_NUM-1:0],
    output logic sa_request_o [PORT_NUM-1:0][VC_NUM-1:0],
    input logic [VC_SIZE-1:0] sa_sel [PORT_NUM-1:0],
    input logic sa_valid_sel [PORT_NUM-1:0],

    output flit_t flit_crossbar [PORT_NUM-1:0]
*/
);
