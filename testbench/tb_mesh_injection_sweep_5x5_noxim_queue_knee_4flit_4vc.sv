...
module tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit_4vc #(
    ...
    task dump_output();
        $dumpfile("out.vcd");
        $dumpvars(0, tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit_4vc);//Modify use independent four-VC 4-flit knee sweep top, Michael Tan, 20260715
    endtask
