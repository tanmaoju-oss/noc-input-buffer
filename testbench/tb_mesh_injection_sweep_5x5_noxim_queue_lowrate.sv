...
module tb_mesh_injection_sweep_5x5_noxim_queue_lowrate #(
    ...
    parameter RATE_NUM = 14,//Modify add low injection-rate points before 0.1, Michael Tan, 20260709
    ...
    task dump_output();
        $dumpfile("out.vcd");
        $dumpvars(0, tb_mesh_injection_sweep_5x5_noxim_queue_lowrate);//Modify use independent low-rate queue-based sweep top, Michael Tan, 20260709
    endtask
    ...
    task initialize_global();
        ...
        inj_rates_permille[0] = 10;//Modify add 0.01 low-load point, Michael Tan, 20260709
        inj_rates_permille[1] = 20;//Modify add 0.02 low-load point, Michael Tan, 20260709
        inj_rates_permille[2] = 30;//Modify add 0.03 low-load point, Michael Tan, 20260709
        inj_rates_permille[3] = 40;//Modify add 0.04 low-load point, Michael Tan, 20260709
        inj_rates_permille[4] = 50;//Modify add 0.05 low-load point, Michael Tan, 20260709
        inj_rates_permille[5] = 60;//Modify add 0.06 low-load point, Michael Tan, 20260709
        inj_rates_permille[6] = 70;//Modify add 0.07 low-load point, Michael Tan, 20260709
        inj_rates_permille[7] = 80;//Modify add 0.08 low-load point, Michael Tan, 20260709
        inj_rates_permille[8] = 90;//Modify add 0.09 low-load point, Michael Tan, 20260709
        inj_rates_permille[9] = 100;//Modify keep 0.10 point for comparison, Michael Tan, 20260709
        inj_rates_permille[10] = 200;//Modify keep 0.20 point for comparison, Michael Tan, 20260709
        inj_rates_permille[11] = 300;//Modify keep 0.30 point for comparison, Michael Tan, 20260709
        inj_rates_permille[12] = 400;//Modify keep 0.40 point for comparison, Michael Tan, 20260709
        inj_rates_permille[13] = 500;//Modify keep 0.50 point for comparison, Michael Tan, 20260709
