//Modify add a short performance-TB sweep for the final 0.19 and 0.20 board comparison points, Michael Tan, 20260908
`timescale 1ns / 1ps

import noc_params::*;

module tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit_4vc_rate_019_to_020 #(
    ...
    parameter RATE_NUM = 2,//Modify scan only the 0.19 and 0.20 completion points, Michael Tan, 20260908
    ...
    task dump_output();
        $dumpfile("out.vcd");
        $dumpvars(0, tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit_4vc_rate_019_to_020);//Modify bind the optional dump to the two-point completion TB, Michael Tan, 20260908
    endtask
    ...
    task initialize_global();
        ...
        inj_rates_permille[0] = 190;//Modify add the 0.19 completion point, Michael Tan, 20260908
        inj_rates_permille[1] = 200;//Modify add the 0.20 completion point, Michael Tan, 20260908
