...
module tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit #(
    ...
    task dump_output();
        $dumpfile("out.vcd");
        $dumpvars(0, tb_mesh_injection_sweep_5x5_noxim_queue_knee_4flit);//Modify use independent 4-flit knee-rate queue-based sweep top, Michael Tan, 20260709
    endtask
