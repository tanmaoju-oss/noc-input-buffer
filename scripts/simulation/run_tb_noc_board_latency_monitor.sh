...
# Modify add WSL/Linux Vivado runner for board-step-3 latency-monitor verification, Michael Tan, 20260817
set -euo pipefail
...
SIM_DIR="${REPO_ROOT}/vivado_sim_wsl/tb_noc_board_latency_monitor_sim"
VIVADO_ROOT="${VIVADO_ROOT:-/home/tanma/tools/Xilinx/2025.2/Vivado}"
TOP="tb_noc_board_latency_monitor"
