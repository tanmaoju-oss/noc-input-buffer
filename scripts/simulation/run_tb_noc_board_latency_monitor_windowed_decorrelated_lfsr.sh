...
# Modify add WSL/Linux Vivado runner for the decorrelated injection-LFSR board latency diagnostic, Michael Tan, 20260827
set -euo pipefail
...
SIM_DIR="${REPO_ROOT}/vivado_sim_wsl/tb_noc_board_latency_monitor_windowed_decorrelated_lfsr_sim"
VIVADO_ROOT="${VIVADO_ROOT:-/home/tanma/tools/Xilinx/2025.2/Vivado}"
TOP="tb_noc_board_latency_monitor_windowed_decorrelated_lfsr"
