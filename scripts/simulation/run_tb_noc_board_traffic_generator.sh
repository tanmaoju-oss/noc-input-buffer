...
# Modify add WSL/Linux Vivado runner for board-step-2 traffic-generator verification, Michael Tan, 20260805
set -euo pipefail
...
SIM_DIR="${REPO_ROOT}/vivado_sim_wsl/tb_noc_board_traffic_generator_sim"
VIVADO_ROOT="${VIVADO_ROOT:-/home/tanma/tools/Xilinx/2025.2/Vivado}"
TOP="tb_noc_board_traffic_generator"
