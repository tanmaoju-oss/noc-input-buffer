...
# Modify add WSL/Linux Vivado runner for board latency statistics-window alignment verification, Michael Tan, 20260827
set -euo pipefail
...
SIM_DIR="${REPO_ROOT}/vivado_sim_wsl/tb_noc_board_latency_monitor_windowed_sim"
VIVADO_ROOT="${VIVADO_ROOT:-/home/tanma/tools/Xilinx/2025.2/Vivado}"
TOP="tb_noc_board_latency_monitor_windowed"
